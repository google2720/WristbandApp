...
public class StepDataFragment extends Fragment {
    ...
    public static StepDataFragment newInstance(Calendar calendar) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_step_data, container, false);
    }
    ...
    private Fragment createDayFragment(Calendar calendar) {
        ...
        return StepDataDayFragment.newInstance(startDate, endDate);
    }
