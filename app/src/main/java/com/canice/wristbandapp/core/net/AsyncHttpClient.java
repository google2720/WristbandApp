...
//			sf.setHostnameVerifier(SSLSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
    ...
    // HTTP POST Requests
    //
    public void postWithGeneralPara(String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
    ...
    protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AsyncHttpResponseHandler responseHandler, Context context) {
        ...
        if (SetLanguageActivity.EN == UserController.getLanguage(APP.getInstance().getApplicationContext())) {
            uriRequest.addHeader("yuyan", "1");
        } else if (SetLanguageActivity.AUTO == UserController.getLanguage(APP.getInstance().getApplicationContext())) {
