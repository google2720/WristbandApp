...
import android.widget.LinearLayout;
	 ...
	 *
	 */
public class OceanRippleLayout extends LinearLayout implements Runnable{
	...
	private int INVALIDATE_DURATION = 0;
	...
	public OceanRippleLayout(Context context) {
		super(context);
		init();
	}
	
	public OceanRippleLayout(Context context, AttributeSet attrs){
		super(context,attrs);
		init();
	}
	
	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
	public OceanRippleLayout(Context context, AttributeSet attrs, int defStyleAttr){
	...
	public void init(){
		...
		mPaint.setColor(getResources().getColor(R.color.button_style));
	}
