...
package com.canice.wristbandapp.widget.xclcharts.view;
...
import com.canice.wristbandapp.widget.xclcharts.chart.DialChart;
...
import com.canice.wristbandapp.widget.xclcharts.renderer.plot.PlotAttrInfo;
import com.canice.wristbandapp.widget.xclcharts.renderer.plot.Pointer;
...
//				chart.setBackgroundColor( Color.rgb(28, 129, 243) );
		...
		public void addAxis()
		{
			...
			chart.addStrokeRingAxis(1.00f, 0.72f, ringPercentage, rcolor);
		...
		private void addAttrInfo()
		{
			...
			paintTB.setTextSize(getResources().getDimension(R.dimen.dialChart_paintTB));	
			paintTB.setAntiAlias(true);	
			plotAttrInfo.addAttributeInfo(XEnum.Location.TOP, "目前体重", 0.3f, paintTB);
			
			Paint paintBT = new Paint();
			paintBT.setColor(Color.WHITE);
			paintBT.setTextAlign(Align.CENTER);
			paintBT.setTextSize(getResources().getDimension(R.dimen.dialChart_paintBT));
			paintBT.setFakeBoldText(true);
			paintBT.setAntiAlias(true);	
			plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, 
					Float.toString(MathHelper.getInstance().round(mPercentage * 100,2)) + "KG", 0.3f, paintBT);
...
//			plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, "KG", 0.4f, paintBT2);				
		}
